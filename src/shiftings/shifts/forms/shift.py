...
from django.forms import Form, HiddenInput, ModelChoiceField, ModelForm, modelformset_factory
...
class ShiftForm(ModelForm):
    ...
    def __init__(self, *args: Any, **kwargs) -> None:
        ...
        if self.instance and self.instance.shift_type and self.instance.shift_type.is_system:
            include_system = True
        organization = self.instance.organization if self.instance else self.initial['organization']
...
ShiftFormSet = modelformset_factory(Shift, ShiftForm, extra=0, can_delete=False)
