    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manually_disabled', models.BooleanField(default=False, verbose_name='Manuelly Disabled')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('place', models.CharField(blank=True, max_length=100, null=True, verbose_name='Place')),
                ('required_users', models.PositiveIntegerField(default=0, verbose_name='Required Users')),
                ('max_users', models.PositiveIntegerField(default=0, verbose_name='Maximum Users')),
                ('additional_infos', models.TextField(blank=True, null=True, verbose_name='Additional Infos')),
